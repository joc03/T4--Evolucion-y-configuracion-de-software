<%-- 
    Document   : PedidosTransporteMaquinaria
    Created on : 24/11/2020, 04:57:56 AM
    Author     : josed
--%>
...
<%@page import="be.RegistrarSolicitudTransporteMaquinaria"%>
        ...
        <div class="container-fluid ">
            ...
            <div class="card" style="width: 100%; background: #ffcc20">
                <div class="card-title" style="text-align: left">
                    ...
                    <div class="row">
                       <div class="col-11">
                        <b><h3>SOLICITUD N° <%= entidad.getCodigo() %></h3></b>
                    </div>
                        <div class="col-1">
                            <button class="btn btn-outline-danger" style=" float: right"
                                    onclick='eliminarSolicitudTransporteMaquinaria(
                        ...
                        <div class="card-footer" style="background: #ffcc20">
                            <div class="row">
                                <div class="col-12" style="text-align: center">
                                    <button class="btn btn-primary" onclick='AgregarPedidoTMaq( "<%= entidad.getCodigo()%>",
                                                "<%= entidad.getDni()%>","<%= entidad.getCodcont()%>","<%= entidad.getApellido()%>",
                                                "<%= entidad.getPrecio()%>",
                                                "<%= entidad.getFecha()%>","<%= entidad.getChofer()%>")'>GENERAR PEDIDO</button>
                                </div>
