<%-- 
    Document   : TransporteMaquinariaCliente
    Created on : 22/10/2020, 08:08:00 AM
    Author     : josed
--%>
    ...
    <body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12" >
                            ...
                            <input type="text" value=" <%= entidad.getApelli_cli()  %>" id="textApelliTMaq" readonly=""
                        ...
                        <div class="col-12">
                            <input type="text" class="form-control" value="<%= entidad.getTelef_cli()%>" readonly="">                            
                        </div>
                    </div>
